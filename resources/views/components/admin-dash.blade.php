    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-bs-toggle="collapse" href="#admin-users" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-bs-toggle="collapse" href="#admin-posts" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
            ...
            <div class="collapse" id="admin-posts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('view-posts') }}">View Posts</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('add-post') }}">Add Post</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('post-categories') }}">Post Categories</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" data-bs-toggle="collapse" href="#admin-products" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
            ...
            <div class="collapse" id="admin-products">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('view-products') }}">View Products</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('add-product') }}">Add Product</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('product-categories') }}">Product Categories</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                        <form method="POST" action="{{ route('logout') }}">
                          @csrf  
                           <button class="preview-subject mb-1 admin-logout" type="submit">
                              {{ __('Log Out') }}
                            </button>
                        </form>
                    </div>
